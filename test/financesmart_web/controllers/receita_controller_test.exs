defmodule FinancesmartWeb.ReceitaControllerTest do
  use FinancesmartWeb.ConnCase

  import Financesmart.FinanceFixtures

  @create_attrs %{data: ~D[2024-11-26], descricao: "some descricao", valor: "120.5", categoria: "some categoria"}
